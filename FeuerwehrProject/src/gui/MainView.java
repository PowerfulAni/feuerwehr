...
public class MainView extends JScrollPane {
	...
	public MainView(JTextPane panelMain, Feuerwache feuerwache) {
		...
		content += """
				...
				""";
		content += "<tr><td>Verfügbar</td><td>" + fahrzeugeVerfuegbar + "</td><td></td><td>Verfügbar</td><td>"
				+ feuerwehrLeuteVerfuegbar + "</td></tr>";
		content += "<tr><td>Im Einsatz</td><td>" + fahrzeugeEinsatz + "</td><td></td><td>Im Einsatz</td><td>"
				+ feuerwehrLeuteEinsatz + "</td></tr>";

		content += "<tr><td>In Wartung</td><td>" + fahrzeugeWartung + "</td><td></td><td>Im Urlaub</td><td>"
				+ feuerwehrLeuteWartung + "</td></tr>";
		content += "<tr><td></td><td></td><td></td><td>Krank</td><td>" + feuerwehrLeuteKrank + "</td></tr>";

		content += "<tr><td>Gesamt</td><td>" + fahrzeugeAbsolut + "</td><td></td><td>Gesamt</td><td>"
				+ feuerwehrLeuteAbsolut + "</td></tr>";
		...
		content += """
				...
				""";
		content += feuerwache.kannErzeugeVorschlag("Wohnungsbrand") ? "<td style='color: green;'>Bereit</td>"
				: "<td style='color: red;'>Nicht bereit</td>";
		content += feuerwache.kannErzeugeVorschlag("Verkehrsunfall") ? "<td style='color: green;'>Bereit</td>"
				: "<td style='color: red;'>Nicht bereit</td>";
		content += feuerwache.kannErzeugeVorschlag("Naturkatastrophe") ? "<td style='color: green;'>Bereit</td>"
				: "<td style='color: red;'>Nicht bereit</td>";
		content += feuerwache.kannErzeugeVorschlag("Industrieunfall") ? "<td style='color: green;'>Bereit</td>"
				: "<td style='color: red;'>Nicht bereit</td>";
